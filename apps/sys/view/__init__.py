...
from apps.sys.view.message import router as message_router
from apps.sys.view.role import router as role_router
from apps.sys.view.service_account import router as service_account_router
from apps.sys.view.upload import router as upload_router
from apps.sys.view.user import router as user_router

router = Router()
router.add_router("/auth", auth_router)
router.add_router("/service-account", service_account_router)
...
router.add_router("/message", message_router)
